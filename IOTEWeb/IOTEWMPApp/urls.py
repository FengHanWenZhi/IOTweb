...
urlpatterns = [
     ...
     url(r'^floodlightWork/$', views.floodlightWork),
     url(r'^floodlightRenew/$', views.floodlightRenew),

     url(r'^temperatureSensor/$', views.temperatureSensor),#新增，删除温度传感器
     url(r'^temperatureMonitor/$', views.temperatureMonitor),#温度传感器数据处理
     url(r'^temperatureWork/$', views.temperatureWork),
     url(r'^temperatureRenew/$', views.temperatureRenew),

     url(r'^humiditySensor/$', views.humiditySensor),#新增，删除湿度传感器
     url(r'^humidityMonitor/$', views.humidityMonitor),#湿度传感器数据处理
     url(r'^humidityWork/$',views.humidityWork),
     url(r'^humidityRenew/$', views.humidityRenew),
]